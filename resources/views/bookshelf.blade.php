...
{{--                                    <span class="mx-2">{{$getRating($book->id)[1]}} Feedbacks</span>--}}
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                ...
                                <h6 class="text-success">{{date('d M Y',(int)$book['date'])}}</h6>
                                <h6 class="text-warning">{{$book['status']}}</h6>
                                <form id="delete-{{$book['id']}}" method="POST" action="{{ route('bookshelf.destroy',parameters: $book['id']) }}">
                                    @csrf
                                ...
                                <div class="d-flex flex-column mt-4">
                                    ...
                                    <input type="submit" value="Remove From Bookshelf" class="btn btn-danger btn-sm mt-3" form="delete-{{$book['id']}}" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row px-5 justify-content-between mt-2">
            <div class="col-md-3 px-5">
                <h3 class="text-primary">Stories</h3>
            </div>
        </div>
        @if(count($stories) == 0)
            <div class="d-flex justify-content-center row">
...
{{--                                    <span>310</span>--}}
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                ...
                                <h6 class="text-success">{{date('d M Y',(int)$story['created_at'])}}</h6>
                                <h6 class="text-warning">{{$story['status']}}</h6>
                                <form id="delete{{$story['id']}}" method="POST" action="{{ route('bookshelf.destroy',parameters: $story['id']) }}">
                                    @csrf
                                ...
                                <div class="d-flex flex-column mt-4">
                                    ...
                                    <input type="submit" value="Remove From Bookshelf" class="btn btn-danger btn-sm mt-3" form="delete{{$story['id']}}" />
                                </div>
                            </div>
                        </div>
                    </div>
